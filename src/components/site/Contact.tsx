  ...
  return (
    <section id="contact" className="border-t border-hairline py-20 sm:py-28">
      <div className="mx-auto max-w-6xl px-5 sm:px-8">
        ...
        <Reveal delay={70}>
          <h2 className="mt-4 max-w-2xl text-3xl font-semibold sm:text-4xl">Let&rsquo;s connect.</h2>
        </Reveal>
        <Reveal delay={110}>
        ...
        <div className="mt-12 max-w-2xl divide-y divide-hairline border-y border-hairline">
          {ROWS.map((r, i) => (
            <Reveal key={r.label} delay={i * 60}>
              <a
                ...
                className="group flex items-center gap-4 py-5 transition-colors duration-200 hover:text-accent"
              >
                ...
                <span className="truncate text-sm font-medium">{r.value}</span>
          ...
          <Reveal delay={180}>
            <div className="flex items-center gap-4 py-5">
              ...
              <span className="text-sm font-medium">{LINKS.location}</span>
            </div>
          </Reveal>
        </div>
      </div>
